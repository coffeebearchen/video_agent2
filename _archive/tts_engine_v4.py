...
BACKUP_FILE = "script.tts_v4_backup.json"
AUDIO_DIR = "audio"

MODEL_NAME = "gpt-4o-mini-tts"

# 先用内置 voice。官方推荐 marin / cedar 质量更好。
# 如果以后你做了自己的 voice，就把 CUSTOM_VOICE_ID 填上。
BUILTIN_VOICE = "marin"
CUSTOM_VOICE_ID = ""   # 例如：voice_123456。没有就留空。
...
def main():
    print("=== OpenAI TTS Engine V4 开始执行 ===")
