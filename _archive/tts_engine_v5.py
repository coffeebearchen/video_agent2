...
BACKUP_FILE = "script.tts_v5_backup.json"
AUDIO_DIR = "audio"

MODEL_NAME = "gpt-4o-mini-tts"

# 先用最稳的内置声音；如果你想试别的，可以改成 alloy / echo / shimmer
BUILTIN_VOICE = "alloy"

# 如果以后你做了自己的声音，把这里填成 voice_xxx；没有就留空
CUSTOM_VOICE_ID = ""
...
def main():
    print("=== OpenAI TTS Engine V5 开始执行 ===")
